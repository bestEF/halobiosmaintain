    ...
    public HashMap<String,HashMap<String, BigDecimal>>  sedimentstatisticOneYear(String year, String voyage, String element){
        ...
        switch (element) {
            case "cd"://镉
                ...
                //求平均值
                BigDecimal cDave = sediments.stream().map(Sediment::getCd).reduce(BigDecimal.ZERO, BigDecimal::add).divide(BigDecimal.valueOf(sediments.size()), 6, BigDecimal.ROUND_HALF_UP);
            ...
            case "lhw"://硫化物
                ...
                //求平均值
                BigDecimal codave = sediments.stream().map(Sediment::getLhw).reduce(BigDecimal.ZERO, BigDecimal::add).divide(BigDecimal.valueOf(sediments.size()),1, BigDecimal.ROUND_HALF_UP);
            ...
            case "tcr"://总铬
                ...
                //Sediment
                BigDecimal crave = sediments.stream().map(Sediment::getTcr).reduce(BigDecimal.ZERO, BigDecimal::add).divide(BigDecimal.valueOf(sediments.size()),1, BigDecimal.ROUND_HALF_UP);
            ...
            case "cu"://铜
                ...
                //求平均值
                BigDecimal cuave = sediments.stream().map(Sediment::getCu).reduce(BigDecimal.ZERO, BigDecimal::add).divide(BigDecimal.valueOf(sediments.size()),1, BigDecimal.ROUND_HALF_UP);
            ...
            case "yjt"://有机碳
                ...
                //求平均值
                BigDecimal gsyave = sediments.stream().map(Sediment::getYjt).reduce(BigDecimal.ZERO, BigDecimal::add).divide(BigDecimal.valueOf(sediments.size()),3, BigDecimal.ROUND_HALF_UP);
            ...
            case "hg"://汞
                ...
                //求平均值
                BigDecimal hgave = sediments.stream().map(Sediment::getHg).reduce(BigDecimal.ZERO, BigDecimal::add).divide(BigDecimal.valueOf(sediments.size()),4, BigDecimal.ROUND_HALF_UP);
            ...
            case "pb"://铅
                ...
                //求平均值
                BigDecimal pbave = sediments.stream().map(Sediment::getPb).reduce(BigDecimal.ZERO, BigDecimal::add).divide(BigDecimal.valueOf(sediments.size()),1, BigDecimal.ROUND_HALF_UP);
            ...
            case "syl"://石油类
                ...
                //求平均值
                BigDecimal sylave = sediments.stream().map(Sediment::getSyl).reduce(BigDecimal.ZERO, BigDecimal::add).divide(BigDecimal.valueOf(sediments.size()),0, BigDecimal.ROUND_HALF_UP);
            ...
            case "eh"://Eh
                ...
                //求平均值
                BigDecimal yxsydave = sediments.stream().map(Sediment::getEh).reduce(BigDecimal.ZERO, BigDecimal::add).divide(BigDecimal.valueOf(sediments.size()),1, BigDecimal.ROUND_HALF_UP);
