...
@TableName("largezooplankton_inet")
public class LargezooplanktonInet extends Model<LargezooplanktonInet> {
    ...
    public BigDecimal getTotalBiomass() {
        return totalBiomass;
    }

    public void setTotalBiomass(BigDecimal totalBiomass) {
